...
const days = ['Sunday','Monady','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday']
const months = ['Jan','Feb','March','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];
const API_KEY ='9299075eac3db3771fb4c03d4cfc45d9';
setInterval(() => {
    const time= new Date();
...
data.daily.forEach((day,idx) => {
    if(idx == 0){
        ...
        <div class = "other">
            <div class = "day">${window.moment(day.dt*1000)}</div>
